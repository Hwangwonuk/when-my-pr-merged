          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className={`rounded-xl bg-gray-900/60 border border-gray-800 border-t-2 ${feature.accent} p-8 hover:bg-gray-900/80 transition-colors`}
                >
                  <div
        ...
        <section className="py-24">
          ...
          <div className="space-y-3 max-w-2xl mx-auto">
            {[
              ...
              <div
                key={insight}
                className="flex items-center gap-4 rounded-lg bg-gray-900/60 border border-gray-800 px-5 py-4 hover:border-gray-700 transition-colors"
              >
